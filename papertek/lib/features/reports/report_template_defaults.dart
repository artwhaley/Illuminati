...
const kDefaultTemplates = [
  ReportTemplate(
    ...
    columns: [
      ...
      ReportColumn(id: 'instrument', label: 'TYPE',     fieldKeys: ['instrument'], widthPercent: 28),
      ReportColumn(id: 'purpose',    label: 'PURPOSE',  fieldKeys: ['purpose'],    widthPercent: 22),
  ...
  ReportTemplate(
    ...
    columns: [
      ...
      ReportColumn(id: 'instrument',  label: 'INSTRUMENT', fieldKeys: ['instrument'], widthPercent: 28),
      ReportColumn(id: 'position',    label: 'POSITION',   fieldKeys: ['position'],   widthPercent: 22),
      ReportColumn(id: 'purpose',     label: 'PURPOSE',    fieldKeys: ['purpose'],    widthPercent: 20),
  ...
  ReportTemplate(
    ...
    columns: [
      ...
      ReportColumn(id: 'instrument',  label: 'INSTRUMENT', fieldKeys: ['instrument'], widthPercent: 40),
