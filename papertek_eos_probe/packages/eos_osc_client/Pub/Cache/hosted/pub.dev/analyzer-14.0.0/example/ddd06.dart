  ...
  for (var i = 0; i < 10; i++) {
    ...
    var collection = AnalysisContextCollectionImpl(
      ...
      includedPaths: [
        ...
        // '/Users/scheglov/Source/flutter/packages/flutter/test/widgets/context_menu_controller_test.dart',
        // '/Users/scheglov/Source/Dart/sdk.git/sdk/pkg/analysis_server',
        // '/Users/scheglov/dart/2026-01-29/dependency_resolution',
        '/Users/scheglov/Source/Dart/sdk.git/sdk/pkg/_fe_analyzer_shared/test/metadata/data/type/main.dart',
      ],
      byteStore: byteStore,
      withFineDependencies: true,
      // drainStreams: false, // TODO(scheglov): Remove it.
    );
    ...
    for (var analysisContext in collection.contexts) {
      // analysisContext.driver.exceptions.listen((data) {
